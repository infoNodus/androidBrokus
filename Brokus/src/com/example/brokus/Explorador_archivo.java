...
public class Explorador_archivo extends ListActivity {
	   ...
	   public void onCreate(Bundle savedInstanceState) {
	          ...
	          setContentView(R.layout.activity_explorador_archivo);          
	   ...
	   private void getDir(String dirPath){
	       ...
	       ArrayAdapter<String> fileList =
	          new ArrayAdapter<String>(this, R.layout.item_row_explorador, item);
	   ...
	   public void onBackPressed() {
		   ...
		   alert.setTitle("Quieres Salir?");
	       alert.setMessage("Estas seguro que quieres salir sin haber seleccionar un archivo?");
